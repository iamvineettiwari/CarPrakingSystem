  ...
  if ($_SESSION['user_type'] == "user" && $_SESSION['user_id'] != "") {
    ...
    <body>
      ...
      <div class="col s12 welcome-content">
        <div class="row">
          <div class="col m6">
            <p class="welcome-text">Welcome, <span class="green-text"><?php echo strtoupper($user['user_first_name'] . " " . $user['user_last_name']); ?></span></p>
          </div>
          <div class="col m6">
            <p class="welcome-location">Current Location : <span class="green-text" id="current-location"></span></p>
          </div>
        </div>
      </div>

      <div class="heading col s12 deep-purple-text">
        Parking places near you
      </div>
      <div id="places">
        <div class="row" id="getPlaceData">
