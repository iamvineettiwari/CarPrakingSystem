...
if (isset($_SESSION['user_type']) && isset($_SESSION['user_id'])) {
    if ($_SESSION['user_type'] == "user" && $_SESSION['user_id'] != "") {
        ...
        $userData = isset($_POST['pid']) ? mysqli_real_escape_string($db, $_POST['pid']) : "";
        ...
        <body>
            ...
            <div class="col s12 welcome-content">
                <div id="befApp">
                    <p class="welcome-text">Check Availabilty</p>
                    <form id="checkAvail">
                        <div class="row">
                            <div class="col s12 m3">
                                <input type="hidden" name="pid" value="<?php echo $userData; ?>">
                            ...
                            <div class="col s12 m3">
                                <div class="input-field">
                                    <input type="text" name="time" required class="timepicker">
                                    <label for="time">Choose In Time</label>
                                </div>
                            </div>
                            <div class="col s12 m3">
                                <div class="input-field">
                                    <input type="text" name="out" required class="timepicker">
                                    <label for="time">Choose Out Time</label>
                                </div>
                            </div>
                            <div class="col s12 m3">
                                <div class="input-field">
        ...
        <li><a class="waves-effect" href="cancelledBookings.php"><i class="material-icons">cancel</i>Cancellation History</a></li>
            ...
            <script src="../js/check-avail.js"></script>
            <script>
